...
namespace Base {
	...
	class BASESHARED_EXPORT ActionContainer : public QObject
	{
		Q_OBJECT
	public:
		ActionContainer(ActionContainerType type, QObject * parent = 0);
		~ActionContainer();
		...
		ActionContainerType containerType() const { return m_type; }

	protected:
		ActionContainerType m_type;
	...
	class BASESHARED_EXPORT ActionContainerProxy : public ActionContainer
	{
		Q_OBJECT
	public:
		explicit ActionContainerProxy(Id id, ActionContainerType type, QObject * parent = 0);
